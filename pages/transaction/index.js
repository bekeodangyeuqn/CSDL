      ...
      >
        <div>
          <div className='flex justify-between'>
            ...
            <button className='px-2 py-1 mr-2 rounded bg-sky-500 w-20' onClick={() => toggleModal()}>Close</button>
          </div>
          <div>
      ...
      <table class="table-auto w-full">
        ...
        <tbody>
          <tr>
            ...
            <td className='text-center'><span className='text-yellow-500'>On going</span>/<span className='text-orange-500'>Late</span>/<span className='text-green-500'>Complete</span></td>
            <td className='text-center'>Yes/No</td>
            <td className='text-center'>None/Late 2 days</td>
            <td className='text-center'>
              <button className='px-2 py-1 mr-2 rounded bg-sky-500 w-20' onClick={() => toggleModal()}>View</button>
              <button className='px-2 py-1 rounded bg-green-500 w-20'>Complete</button>
            </td>
          </tr>
          <tr>
          </tr>
