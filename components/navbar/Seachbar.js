  ...
  return (
    <div className="flex space-x-2 items-center">
      ...
      <div className="flex items-center">
        <label
          htmlFor="search-by"
          className="block mr-2 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-400"
        >
          Search by
        </label>
        <select
          id="search-by"
          className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg hover:outline-none
